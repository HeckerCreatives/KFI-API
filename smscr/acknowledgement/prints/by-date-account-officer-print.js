...
exports.printByDateByAccountOfficer = (datas, from = "", to = "") => {
  ...
  datas.map(acknowledgement => {
    rows.push([
      { text: `${acknowledgement._id}`, colSpan: 10, fontSize: 8, margin: [0, 1, 0, 1], border: [0, 0, 0, 0] },
    ...
    acknowledgement.acknowledgements.map(data => {
  ...
  const contents = [
    ...
    { text: "Official Receipt By Date ( Account Officer )", fontSize: 9 },
