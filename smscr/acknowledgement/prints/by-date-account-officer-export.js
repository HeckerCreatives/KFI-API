...
exports.exportDetailedByDateByAccountOfficer = (acknowledgements, from, to) => {
  const rows = [];
  ...
  acknowledgements.map(acknowledgement => {
    rows.push([{ v: `${acknowledgement._id}`, t: "s", s: { alignment: { vertical: "center" } } }]);
  ...
  const headerSubtitle = `Official Receipt By Date ( Account Officer )`;
