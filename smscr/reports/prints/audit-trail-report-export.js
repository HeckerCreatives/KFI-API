...
exports.exportAuditTrailReporExcel = (entries, beginningBalance, from, to) => {
  const rows = [];
  ...
  rows.push([
    ...
    { v: "Acct. Officer", t: "s", s: { font: { bold: true }, alignment: { vertical: "center" }, border: topBottomBorder } },
    ...
    chart.entries.map((entry, h) => {
      if (beginningBalance && i === 0 && h === 0) {
        ...
        rows.push([
          ...
          { v: ``, t: "s", s: { alignment: { vertical: "center" } } },
          {
            v: `${Number(beginningBalance.debit) !== 0 ? formatNumber(beginningBalance.debit) : ""}`,
            t: "s",
            s: { alignment: { vertical: "center", horizontal: "right" }, border: topBorder },
          },
          {
            v: `${Number(beginningBalance.credit) !== 0 ? formatNumber(beginningBalance.credit) : ""}`,
            t: "s",
            s: { alignment: { vertical: "center", horizontal: "right" }, border: topBorder },
          },
        ]);
      ...
      rows.push([
        ...
        { v: `${entry?.particular || ""}`, t: "s", s: { alignment: { vertical: "center" } } },
        { v: `${entry?.acctOfficer || ""}`, t: "s", s: { alignment: { vertical: "center" } } },
        { v: `${chart.code}`, t: "s", s: { alignment: { vertical: "center" } } },
        { v: `${chart.description}`, t: "s", s: { alignment: { vertical: "center" } } },
      ...
      rows.push([
        ...
        { v: ``, t: "s", s: { alignment: { vertical: "center" } } },
        { v: ``, t: "s", s: { alignment: { vertical: "center" } } },
        { v: `${Number(entry.debit) !== 0 ? formatNumber(entry.debit) : ""}`, t: "s", s: { alignment: { vertical: "center", horizontal: "right" }, border: topBorder } },
        { v: `${Number(entry.credit) !== 0 ? formatNumber(entry.credit) : ""}`, t: "s", s: { alignment: { vertical: "center", horizontal: "right" }, border: topBorder } },
      ]);
  ...
  const headerSubtitle = `G / L Audit Trail`;
  ...
  XLSX.utils.book_append_sheet(workbook, worksheet, "GL Audit Trail Report");
