                      ...
                      table: {
                        ...
                        body: [
                          [
                            ...
                            { text: `P ${formatNumber(journal.amount)}`, fontSize: 8, bold: true, margin: [0, 0, 0, 0], border: [0, 0, 0, 1] },
                          ],
                        ],
                      },
                    },
                      ...
                      table: {
                        ...
                        body: [
                          [
                            ...
                            { text: `${numberToWordsWithDecimals(Number(journal.amount).toFixed(2))}`, fontSize: 8, bold: true, margin: [0, 0, 0, 0], border: [0, 0, 0, 1] },
                          ],
                        ],
                      },
                    },
