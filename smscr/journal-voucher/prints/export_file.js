...
exports.journalVoucherExportFile = (journal, payTo, entries, signature, loggedInUser) => {
  ...
  if (journal.remarks) particulars.push(`${journal.remarks}`);
  entries.map(entry => {
  ...
  let datas = [
    ...
    [{ v: "" }],
    [{ v: "CHECK VOUCHER ( JOURNAL VOUCHER )", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" } }, merge: { cols: 5 } }],
    [{ v: "" }],
    [
      { v: "NATURE", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "left" } } },
      ...
      { v: `${completeNumberDate(journal.date)}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: botBorder } },
    ],
    [
      { v: "AMOUNT", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "left" } } },
      {
        v: `( In Figures ) P ${formatNumber(journal.amount)}`,
        t: "s",
      ...
      { v: `${journal.code}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: botBorder } },
    ],
    [
      { v: "", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "left" } } },
      {
        v: `( In Words ) ${numberToWordsWithDecimals(Number(journal.amount).toFixed(2))}`,
        t: "s",
      ...
      { v: `${journal.bankCode.description}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: botBorder } },
    ],
    [
      { v: "", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "left" } } },
      { v: "", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" } } },
      ...
      { v: `${journal.checkNo}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: botBorder } },
    ],
    [
      { v: "", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "left" } } },
      { v: "", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "left" } } },
      ...
      { v: `${completeNumberDate(journal.checkDate)}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: botBorder } },
    ],
    [{ v: "" }],
    [
      {
