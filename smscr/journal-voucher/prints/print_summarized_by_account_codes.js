...
exports.jvPrintSummarizedByAccounts = (datas, from = "", to = "") => {
    ...
    journals.map(loan => {
      ...
      loan.entries.map(entry => {
        ...
        journalVouchers.push([
          ...
          { text: `${entry?.journal?.nature || ""}`, fontSize: 8, margin: [0, 0, 0, 0], border: [0, 0, 0, 0] },
  ...
  const contents = [
    ...
    { text: "Journal Voucher By Account ( Sort By Client )", fontSize: 9 },
