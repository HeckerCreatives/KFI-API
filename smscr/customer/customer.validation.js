...
exports.customerRules = [
  ...
  body("acctNumber").trim().notEmpty().withMessage("Account no. is required").isLength({ min: 1, max: 255 }).withMessage("Account no. must only consist of 1 to 255 characters"),
