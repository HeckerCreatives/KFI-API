...
exports.chartOfAccountRules = [
  ...
  body("indentation").trim().notEmpty().withMessage("Indentation is required").isLength({ min: 1, max: 255 }).withMessage("Indentation must consist of only 1 to 255 characters."),
