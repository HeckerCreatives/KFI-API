...
exports.acknowledgementReceiptExportFile = (officialReceipt, payTo, entries) => {
  let particulars = [];
  let accountEntries = [];
  let totalDebit = 0;
  let totalCredit = 0;
  ...
  if (officialReceipt.remarks) particulars.push(`${officialReceipt.remarks}`);
  entries.map(entry => {
  ...
  let datas = [
    ...
    [{ v: "" }],
    [{ v: "OFFICIAL RECEIPT ( ACKNOWLEDGEMENT )", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" } }, merge: { cols: 5 } }],
    [{ v: "" }],
    [
      { v: "RECEIVED FROM", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "left" } } },
      ...
      { v: `${completeNumberDate(officialReceipt.date)}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: botBorder } },
    ],
    [
      ...
      { v: `${officialReceipt.code}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: botBorder } },
    ],
    [
      ...
      { v: "CENTER", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "left" } } },
      { v: `${officialReceipt.center.centerNo}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: botBorder } },
    ],
    [
      { v: "", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "left" } } },
      { v: "", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" } } },
      { v: "", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" } } },
      { v: "AO", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "left" } } },
      { v: `${officialReceipt.acctOfficer}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: botBorder } },
    ],
    [
      { v: "", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "left" } } },
      { v: "", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" } } },
      ...
      { v: `${officialReceipt.bankCode.description}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: botBorder } },
    ],
    [
      { v: "MODE OF PAYMENT", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "left" } } },
      { v: `${officialReceipt.type.toUpperCase()}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "left" }, border: botBorder } },
      { v: "", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: botBorder } },
  ...
  merges.push({ s: { r: 8, c: 1 }, e: { r: 8, c: 2 } }, { s: { r: 9, c: 1 }, e: { r: 9, c: 2 } }, { s: { r: 12, c: 1 }, e: { r: 12, c: 2 } });

  ws["!merges"] = merges;

  ws["!cols"] = Array.from(Array(5)).fill({ wch: 30 });

  XLSX.utils.book_append_sheet(wb, ws, "Official Receipt");
