...
const export_excel_detailed = (data, res, docNoFrom, docNoTo) => {
  ...
  let title = "";
  if (docNoFrom && !docNoTo) title = `Doc. No. From EV#${docNoFrom}`;
  if (docNoTo && !docNoFrom) title = `Doc. No. To EV#${docNoTo}`;
  if (docNoTo && docNoFrom) title = `Doc. No. From EV#${docNoFrom} To EV#${docNoTo}`;
