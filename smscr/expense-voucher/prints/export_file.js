...
exports.expenseVoucherExportFile = (expense, payTo, entries) => {
  let particulars = [];
  let accountEntries = [];
  let totalDebit = 0;
  let totalCredit = 0;
  ...
  if (expense.remarks) particulars.push(`${expense.remarks}`);
  entries.map(entry => {
  ...
  let datas = [
    ...
    [{ v: "" }],
    [{ v: "CHECK VOUCHER ( EXPENSE VOUCHER )", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" } }, merge: { cols: 5 } }],
    [{ v: "" }],
    [
      ...
      { v: `${completeNumberDate(expense.date)}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: botBorder } },
    ],
    [
      ...
      { v: `${expense.code}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: botBorder } },
    ],
    [
      ...
      { v: `${expense.bankCode.description}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: botBorder } },
    ],
    [
      { v: "", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "left" } } },
      { v: "", t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" } } },
  ...
  datas.push(
    ...
    [
      { v: `${expense.preparedBy}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: fullBorder } },
      { v: `${expense.checkedBy}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: fullBorder } },
      { v: ``, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" } } },
      { v: `${expense.approvedBy}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: fullBorder } },
      { v: `${expense.receivedBy}`, t: "s", s: { font: { bold: true }, alignment: { vertical: "center", horizontal: "center" }, border: fullBorder } },
    ]
  );
