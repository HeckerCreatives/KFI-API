...
exports.evPrintSummarizedByAccounts = (datas, from = "", to = "") => {
    ...
    expenses.map(loan => {
      ...
      loan.entries.map(entry => {
        ...
        rows.push([
          ...
          { text: `${entry?.expense?.supplier || ""}`, fontSize: 8, margin: [0, 0, 0, 0], border: [0, 0, 0, 0] },
  ...
  const contents = [
    ...
    { text: "Expense Voucher By Account ( Sort By Client )", fontSize: 9 },
      ...
      table: {
        ...
        body: [
          [
            ...
            { text: "Supplier", fontSize: 8, bold: true, margin: [0, 4.5, 0, 4.5], border: [0, 1, 0, 1], alignment: "left" },
