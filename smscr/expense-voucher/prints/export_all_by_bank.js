...
exports.evExportByBanks = datas => {
  ...
  datas.map((data, i) => {
    ...
    expenseVouchers.push(Array.from({ length: 6 }, () => ({ v: ``, t: "s", s: { alignment: { vertical: "center" } } })));
  });
  ...
  const worksheet = XLSX.utils.aoa_to_sheet(expenseVouchers, { origin: "A7" });
