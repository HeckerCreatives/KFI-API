...
exports.expenseVoucherPrintFile = (payTo, expense, entries) => {
  const info = {
  ...
  if (expense.remarks) particulars += `${expense.remarks}\n`;
  entries.map(entry => {
  ...
  const contents = [
    ...
    { text: "CHECK VOUCHER (EXPENSE VOUCHER)", fontSize: 9, bold: true, alignment: "center", margin: [0, 10, 0, 10] },
    {
      margin: [0, 0, 0, 10],
      table: {
        widths: ["*", "*", "*"],
              ...
              table: {
                ...
                body: [
                  [
                    ...
                    { text: `${completeNumberDate(expense.date)}`, fontSize: 8, bold: true, margin: [0, 0, 0, 0], border: [0, 0, 0, 1] },
                  ],
                  [
                    { text: "DOC. NO", fontSize: 8, bold: true, margin: [0, 0, 0, 0], border: [0, 0, 0, 0] },
                    { text: `${expense.code}`, fontSize: 8, bold: true, margin: [0, 0, 0, 0], border: [0, 0, 0, 1] },
                  ],
                  [
                    { text: "BANK", fontSize: 8, bold: true, margin: [0, 0, 0, 0], border: [0, 0, 0, 0] },
                    { text: `${expense.bankCode.description}`, fontSize: 8, bold: true, margin: [0, 0, 0, 0], border: [0, 0, 0, 1] },
                  ],
                  [
                    { text: "CHECK NO.", fontSize: 8, bold: true, margin: [0, 0, 0, 0], border: [0, 0, 0, 0] },
                    { text: `${expense.checkNo}`, fontSize: 8, bold: true, margin: [0, 0, 0, 0], border: [0, 0, 0, 1] },
                  ],
                  [
                    { text: "CHECK DATE.", fontSize: 8, bold: true, margin: [0, 0, 0, 0], border: [0, 0, 0, 0] },
                    { text: `${completeNumberDate(expense.checkDate)}`, fontSize: 8, bold: true, margin: [0, 0, 0, 0], border: [0, 0, 0, 1] },
                  ],
                ],
              },
            },
      ...
      return {
        ...
        table: {
          ...
          body: [
            ...
            [
              { text: `${expense.preparedBy}`, margin: [0, 3, 0, 3], fontSize: 8, bold: true, alignment: "center" },
              { text: `${expense.checkedBy}`, margin: [0, 3, 0, 3], fontSize: 8, bold: true, alignment: "center" },
              { text: `${expense.approvedBy}`, margin: [0, 3, 0, 3], fontSize: 8, bold: true, alignment: "center" },
              { text: `${expense.receivedBy}`, margin: [0, 3, 0, 3], fontSize: 8, bold: true, alignment: "center" },
            ],
