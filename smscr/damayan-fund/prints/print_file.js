      ...
      return {
        ...
        table: {
          ...
          body: [
            ...
            [
              { text: `${damayan.preparedBy}`, margin: [0, 3, 0, 3], fontSize: 8, bold: true, alignment: "center" },
              { text: `${damayan.checkedBy}`, margin: [0, 3, 0, 3], fontSize: 8, bold: true, alignment: "center" },
              { text: `${damayan.approvedBy}`, margin: [0, 3, 0, 3], fontSize: 8, bold: true, alignment: "center" },
              { text: `${damayan.receivedBy}`, margin: [0, 3, 0, 3], fontSize: 8, bold: true, alignment: "center" },
            ],
