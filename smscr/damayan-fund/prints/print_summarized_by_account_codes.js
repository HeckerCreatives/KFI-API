...
exports.dfPrintSummarizedByAccounts = (datas, from = "", to = "") => {
  const info = { title: "Damayan Fund" };
    ...
    damayans.map(loan => {
      ...
      loan.entries.map(entry => {
        ...
        rows.push([
          ...
          { text: `${entry?.damayan?.nature || ""}`, fontSize: 8, margin: [0, 0, 0, 0], border: [0, 0, 0, 0] },
  ...
  const contents = [
    ...
    { text: "Damayan Fund By Account ( Sort By Client )", fontSize: 9 },
