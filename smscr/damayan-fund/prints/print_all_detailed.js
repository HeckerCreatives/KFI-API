...
exports.damayanFundDetailedPrintAll = (datas, from = "", to = "") => {
  const info = {
    title: "Damayan Fund",
  };
  ...
  datas.map(data => {
    ...
    damayanFunds.push(
      [
        ...
        { text: data.name, fontSize: 10, margin: [0, 1, 0, 1], border: [0, 0, 0, 0] },
  ...
  const contents = [
    ...
    { text: "Damayan Fund By Doc. No. (Detailed)", fontSize: 9 },
      ...
      table: {
        ...
        body: [
          [
            ...
            { text: "Name", fontSize: 10, bold: true, margin: [0, 4.5, 0, 0], border: [0, 1, 0, 1] },
